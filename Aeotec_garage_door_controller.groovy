 ...
 * change log:
 * v 0.1
 * Based on Robert Vandervoort Smartthings code
 * https://github.com/robertvandervoort/SmartThings/tree/master/Aeon%20Garage%20Door
 * 
 * You need to set up polling separately, try HubiPoll
 * https://github.com/HubitatCommunity/Hubi-Poll
*/
...
def zwaveEvent(hubitat.zwave.commands.powerlevelv1.PowerlevelTestNodeReport cmd) {
	...
	def request = [
        hubitat.zwave.commands.powerlevelv1.PowerlevelGet()
    ]
...
def poll() {
    ...
    def request = [
		// we don't need to get battery state here
...
def configure() {
	...
	def request = [
		...
		zwave.configurationV1.configurationSet(parameterNumber: 38, size: 4, configurationValue: [10,2,1,0]),
